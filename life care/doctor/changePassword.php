                ...
                <div class="panel-body">
                  <div class="padd">
                      ...
                      <div class="form quick-post">
                                      ...
                                      <form class="form-horizontal" action="./model/change_Password.php" method="post">
                                          <!-- Title -->
                                          ...
                                          <div class="form-group">
											 ...
											 <div class="col-lg-offset-2 col-lg-9">
												<button type="submit" name="changepass_btn" class="btn btn-success">Change Password</button>			
...
$query = "update patient set password='$newpassword' where emailid='$emailid' and password='$oldpassword'";
$n = my_iud($query);
if($n ==1)
{

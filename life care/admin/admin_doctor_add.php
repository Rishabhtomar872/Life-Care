                      ...
                      <div class="form quick-post">
                                      ...
                                      <form class="form-horizontal" method="post" enctype="multipart/form-data" >
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                              <input type="text" class="form-control" name="specialization" id="tags">
                                            </div>
                                          </div>	
										  ...
										  <div class="form-group">
                                            <label class="control-label col-lg-2" for="tags"><b>Email ID</b></label>
                                            <div class="col-lg-10">
                                              <input type="email" class="form-control" name="emailid" id="tags">
                                            </div>
                                          </div>
										  ...
										  <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                              <input type="email" class="form-control" name="contact" id="tags">
                                            </div>
                                          </div>
										  <div class="form-group">

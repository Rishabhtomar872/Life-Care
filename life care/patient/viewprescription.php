...
$query = "select * from prescription where patient='$emailid'";
$rs = my_select($query);
...
<center><h2 style = "font-family : 'Monotype Corsiva' ; color : #E6120E ; font-weight : bold;margin-top:2%">
    View Prescription</h2></center><hr>
...
<table class="table table-hover" id="example">
  <thead>
  <tr>
     <th><i class="icon_calendar"></i>Doctor</th>
...
?>
  <tr>
    ...
    <td><?=$user['doctor']?></td>
		  ...
		  <td><?=$user['pdate']?></td>
    <!--<td><a href="cancelappointment.php"><button class="btn btn-success" onclick="return confirm('Are you sure?')">Delete</button></a></td>-->
  </tr>
   <?php 
   }
   ?>

							...
							<div class="inline-teasers-wrap">
								<div class="teaser small-teaser media">
									...
									<div class="media-body media-middle">
										<h4>+91 8602768216</h4>
										<p class="greylinks fontsize_12"> <a href="mailto:pharmacom@example.com">myemail@gmail.com</a> </p>
									</div>
								</div>
								<div class="teaser small-teaser media">
									<div class="media-left media-middle">
									...
									<div class="media-body media-middle">
										<h4>482 LMN Street</h4>
										<p class="greylinks fontsize_12"> PQR City, KS 66223 </p>
									</div>
								</div>
							</div>
						</div>
									...
									<ul class="mainmenu nav sf-menu">
										<li class="active"> <a href="index.php">Home</a></li>
										 <li > <a href="searchDoctor.php">Search Doctor</a></li >
										  <!--<li > <a href="cancelappoinment.php">Appointment Cancel</a></li>-->
